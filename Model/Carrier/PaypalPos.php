...
namespace IWD\PaypalPos\Model\Carrier;
 ...
 */
class PaypalPos extends AbstractCarrier implements CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'paypalposshipping';
    ...
    public function collectRates(RateRequest $request)
    {
        if (!$this->getConfigFlag('active')
         || $this->tokenUserContext->getUserType() != UserContextInterface::USER_TYPE_INTEGRATION
        ) {
            return false;
        }
