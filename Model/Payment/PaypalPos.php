 ...
 * @since 100.0.2
 */
class PaypalPos extends \Magento\Payment\Model\Method\AbstractMethod
{
    const PAYMENT_METHOD_CODE = 'paypalpos';
     ...
     * @var string
     */
    protected $_infoBlockType = \IWD\PaypalPos\Block\Info\PaypalPos::class;
